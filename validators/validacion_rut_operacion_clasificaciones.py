# validators/validacion_rut_operacion_clasificaciones.py
from sqlalchemy import text

def validar_rut_operacion_clasificaciones(rut: str, op: str, engine):
    """
    Valida si un RUT y número de operación existen en DS02, DS51 o DS12
    incluyendo sus reprogramaciones.
    Versión usada para procesos de Clasificaciones.
